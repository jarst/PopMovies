...
import coderefactory.net.popmovies.MovieListFragment;
...
public class FetchMovieTask extends AsyncTask<String, Void, List<Movie>> {
    ...
    private final MovieListFragment targetFragment;

    public FetchMovieTask(final Context context, final MovieProvider movieProvider, final MovieListFragment targetFragment) {
